...
OFFICIAL_UPSTREAM_REPO = "https://github.com/ahbohhh/OOF-userbot"
BOT_IS_UP_TO_DATE = "`The userbot is up-to-date.`"
NEW_BOT_UP_DATE_FOUND = (
    "aggiornamento trovato per {branch_name}\n" "changelog: \n\n{changelog}\n" "sto aggiornando ..."
)
NEW_UP_DATE_FOUND = "Ho trovato un nuovo aggiornamento per {branch_name}\n" "`sto aggiornando ...`"
